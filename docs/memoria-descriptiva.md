...
| Calidad | 305 tests automatizados (cobertura 95 %) + set de evaluación de 6 escenarios; lint y formato limpios; CI en GitHub Actions; auditoría adversarial en dos rondas documentada |
