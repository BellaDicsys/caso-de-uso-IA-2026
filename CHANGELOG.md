...
- **memoria**: memoria conversacional con compactación y contextualización
...
- **seguridad**: defensa en profundidad contra inyección de prompt

## 0.8.0 — 2026-08-06

### Nuevas funcionalidades

- **evaluacion**: arnés de métricas de recuperación y verificador de fundamentación

## 0.7.0 — 2026-08-06

### Nuevas funcionalidades

- **router**: ruteo semántico de herramientas en el cliente simulado
